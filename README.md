...
#### 2.1 Fastest method using a summary file generated by Albacore or Guppy
```
...
```
#### 2.2 Indexing without summary file (not recommended for large fast5 directories)

This method will extract the read_id's from the fast5 file. This requires python3, [ont_fast5_api](https://github.com/nanoporetech/ont_fast5_api), and an hdf5 installation.
